...
static struct tegra_dsi_out dsi_lvds_1366_5_pdata;
...
static struct tegra_dc_cmu dsi_lvds_1366_5_cmu = {
...
static int dsi_lvds_1366_5_bl_notify(struct device *unused, int brightness)
{
...
static int dsi_lvds_1366_5_check_fb(struct device *dev, struct fb_info *info)
{
	return info->device == &disp_device->dev;
}

static struct platform_pwm_backlight_data dsi_lvds_1366_5_bl_data = {
	.pwm_id		= 1,
	.max_brightness	= 255,
	.dft_brightness	= 77,
	.pwm_period_ns	= 40000,
	.notify		= dsi_lvds_1366_5_bl_notify,
	/* Only toggle backlight on fb blank notifications for disp1 */
	.check_fb	= dsi_lvds_1366_5_check_fb,
};

static struct platform_device __maybe_unused dsi_lvds_1366_5_bl_device = {
	.name	= "pwm-backlight",
	.id	= -1,
	.dev	= {
		.platform_data = &dsi_lvds_1366_5_bl_data,
	},
};

static struct platform_device __maybe_unused *dsi_lvds_1366_5_bl_devices[] = {
	&dsi_lvds_1366_5_bl_device,
};

static struct tegra_dc_mode dsi_lvds_1366_5_modes[] = {
	{
...
static int dsi_lvds_1366_5_reg_get(struct device *dev)
{
	int err = 0;
...
__used static int dsi_lvds_1366_5_gpio_get(void)
{
	int err = 0;
	...
	err = gpio_request(dsi_lvds_1366_5_pdata.dsi_panel_rst_gpio,
		"panel rst");
	if (err < 0) {
...
static struct tegra_dsi_cmd dsi_lvds_1366_5_init_cmd[] = {
...
static struct tegra_dsi_cmd dsi_lvds_1366_5_suspend_cmd[] = {
...
static int dsi_lvds_1366_5_enable(struct device *dev)
{
	return 0;
}

static int dsi_lvds_1366_5_postpoweron(struct device *dev)
{
	int err = 0;

	err = dsi_lvds_1366_5_reg_get(dev);
	if (err < 0) {
		pr_err("dsi regulator get failed\n");
		goto fail;
	}
#if 0
	err = dsi_lvds_1366_5_gpio_get();
	if (err < 0) {
		pr_err("dsi gpio request failed\n");
		goto fail;
	}
	gpio_direction_output(dsi_lvds_1366_5_pdata.dsi_panel_rst_gpio, 0);
#endif
	if (vdd_lcd_s_1v8) {
...
static struct tegra_dsi_out dsi_lvds_1366_5_pdata = {
	...
	.dsi_init_cmd = dsi_lvds_1366_5_init_cmd,
	.n_init_cmd = ARRAY_SIZE(dsi_lvds_1366_5_init_cmd),
	.dsi_suspend_cmd = dsi_lvds_1366_5_suspend_cmd,
	.n_suspend_cmd = ARRAY_SIZE(dsi_lvds_1366_5_suspend_cmd),
	.ulpm_not_supported = true,
	.dsi2lvds_bridge_enable = true,
};

static int dsi_lvds_1366_5_disable(void)
{
	gpio_direction_output(dsi_lvds_1366_5_pdata.dsi_panel_rst_gpio, 0);
...
static int dsi_lvds_1366_5_postsuspend(void)
{
	/* TODO */
	return 0;
}
...
static int dsi_lvds_1366_5_register_bl_dev(void)
{
	...
	err = platform_add_devices(dsi_lvds_1366_5_bl_devices,
				ARRAY_SIZE(dsi_lvds_1366_5_bl_devices));
	if (err) {
		pr_err("disp1 bl device registration failed");
		return err;
	}

	err = gpio_request(dsi_lvds_1366_5_pdata.dsi_panel_bl_pwm_gpio,
		"panel pwm");
	if (err < 0) {
		pr_err("panel backlight pwm gpio request failed\n");
		return err;
	}
	gpio_free(dsi_lvds_1366_5_pdata.dsi_panel_bl_pwm_gpio);
	return err;
}

static void dsi_lvds_1366_5_set_disp_device
	(struct platform_device *loki_display_device)
{
	disp_device = loki_display_device;
}

static void dsi_lvds_1366_5_dc_out_init(struct tegra_dc_out *dc)
{
	dc->dsi = &dsi_lvds_1366_5_pdata;
	dc->modes = dsi_lvds_1366_5_modes;
    dc->parent_clk = "pll_d_out0";
	dc->n_modes = ARRAY_SIZE(dsi_lvds_1366_5_modes);
	dc->enable = dsi_lvds_1366_5_enable;
...
{
	fb->xres = dsi_lvds_1366_5_modes[0].h_active;
	fb->yres = dsi_lvds_1366_5_modes[0].v_active;
}

static void dsi_lvds_1366_5_sd_settings_init
...
#ifdef CONFIG_TEGRA_DC_CMU
static void dsi_lvds_1366_5_cmu_init(struct tegra_dc_platform_data *pdata)
{
	pdata->cmu = &dsi_lvds_1366_5_cmu;
}
#endif

struct tegra_panel __initdata dsi_lvds_1366_5 = {
	.init_sd_settings = dsi_lvds_1366_5_sd_settings_init,
