...
static struct tegra_dc_cmu lvds_c_1366_14_cmu = {
...
static int  __init __maybe_unused lvds_c_1366_14_register_bl_dev(void)
{
	int err = 0;
...
#ifdef CONFIG_TEGRA_DC_CMU
static void lvds_c_1366_14_cmu_init(struct tegra_dc_platform_data *pdata)
{
	pdata->cmu = &lvds_c_1366_14_cmu;
}
#endif
...
#ifdef CONFIG_TEGRA_DC_CMU
	.init_cmu_data = lvds_c_1366_14_cmu_init,
#endif
};
